...
MXL_DIAG_LAYOUT_CHECK(sizeof(((mxl_diag_msg *)0)->u.video_read) == 48, video_read_size_must_be_48);
MXL_DIAG_LAYOUT_CHECK(sizeof(((mxl_diag_msg *)0)->u.audio_read) == 48, audio_read_size_must_be_48);
MXL_DIAG_LAYOUT_CHECK(sizeof(mxl_diag_msg) == 64, msg_size_must_be_64);
    ...
    mxlStatus mxl_status)
{
    ...
    msg->u.video_read.exec_dur = exec_dur;
    ...
    mxlStatus mxl_status)
{
    ...
    msg->u.audio_read.exec_dur = exec_dur;
